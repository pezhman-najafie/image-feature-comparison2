...
Original file is located at
    https://colab.research.google.com/drive/1iUnh8pFmnlbdDGuSr2kn1A9TwtWKuZmv
"""
...
def calculate_features_and_distances(image_path1, image_path2):
...
mean_correlation = np.corrcoef(mean_var1, mean_var2)[0, 1]
variance_correlation = np.corrcoef(variance_var1, variance_var2)[0, 1]
lbp_correlation = np.corrcoef(lbp1.flatten(), lbp2.flatten())[0, 1]
ltp_correlation = np.corrcoef(ltp1.flatten(), ltp2.flatten())[0, 1]
lpq_correlation = np.corrcoef(lpq1.flatten(), lpq2.flatten())[0, 1]
hog_correlation = np.corrcoef(hog1, hog2)[0, 1]

# Print the distances
print(Fore.GREEN)
print("Euclidean Distance between Mean Vectors:", mean_distance)
print("Correlation between Mean Vectors:", mean_correlation)

print(Fore.WHITE)
print("Euclidean Distance between Variance Vectors:", variance_distance)
print("Correlation between Variance Vectors:", variance_correlation)

print(Fore.CYAN)
print("Euclidean Distance between LBP Vectors:", lbp_distance)
print("Correlation between LBP Vectors:", lbp_correlation)

print(Fore.YELLOW)
print("Euclidean Distance between LTP Vectors:", ltp_distance)
print("Correlation between LTP Vectors:", ltp_correlation)

print(Fore.BLUE)
print("Euclidean Distance between LPQ Vectors:", lpq_distance)
print("Correlation between LPQ Vectors:", lpq_correlation)

print(Fore.RED)
print("Euclidean Distance between HOG Vectors:", hog_distance)
print("Correlation between HOG Vectors:", hog_correlation)

# Example usage:
image_path1 = 'image1.jpg'
image_path2 = 'image2.jpg'
calculate_features_and_distances(image_path1, image_path2)
